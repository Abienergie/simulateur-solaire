        ...
        if (projectionPng) {
          try {
            ...
            if (parts.length === 2) {
              ...
              const maxWidth = page5Width - 80; // 40px margin on each side
              const scale = maxWidth / imgWidth;
              const drawHeight = imgHeight * scale * 0.85; // Réduire la hauteur de 15%
              ...
              console.log('Projection image embedded successfully');
            }
          } catch (imgError) {
